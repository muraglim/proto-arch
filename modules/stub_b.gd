...
『1』navigate to [u]stub[/u] [u]a[/u] and PAUSE [sub]stub b[/sub]
『2』navigate to [u]stub[/u] [u]a[/u] and CLOSE [s]stub b[/s]
『3』navigate to [u]main[/u] [u]menu[/u] and PAUSE [sub]stub b[/sub]
『4』navigate to [u]main[/u] [u]menu[/u] and CLOSE [s]stub b[/s]"""

func _on_input(text: String) -> void:	
	input.clear()
	match text:
		"1":
			req_exit("uid://sew0lmp877f3", Module.SwapType.MIGRATE)
		"2":
