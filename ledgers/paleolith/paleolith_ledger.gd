...
func _ready() -> void:
	data = {
		...
		"typewriter_configs": {
			...
			"paleolith_gather_hub":                 {"chars_per_second": 60.0, "initial_delay": 0.0},
			"paleolith_gather_start_flint":         {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_start_tinder":        {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_start_acacia_gum":    {"chars_per_second": 65.0, "initial_delay": 0.0},
			"paleolith_gather_start_sedge_corms":   {"chars_per_second": 65.0, "initial_delay": 0.0},
			"paleolith_gather_start_crayfish":      {"chars_per_second": 65.0, "initial_delay": 0.0},
			"paleolith_gather_success_acacia_gum":  {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_success_sedge_corms": {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_success_crayfish":    {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_fail_acacia_gum":     {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_fail_sedge_corms":    {"chars_per_second": 70.0, "initial_delay": 0.0},
			"paleolith_gather_fail_crayfish":       {"chars_per_second": 70.0, "initial_delay": 0.0},
		},
	}
