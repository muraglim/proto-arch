...
@onready var arc_panel: RichTextLabel = $VBoxContainer/HBoxContainer/PanelContainer/ArcPanel
@onready var arc_panel_background: RichTextLabel = $VBoxContainer/HBoxContainer/PanelContainer/ArcPanelBackground
@onready var arc_panel_background_color: RichTextLabel = $VBoxContainer/HBoxContainer/PanelContainer/ArcPanelBackgroundColor
...
func set_arc_background_text(text: String) -> void:
	arc_panel_background.text = text

func set_arc_background_color_text(text: String) -> void:
	arc_panel_background_color.text = text
