...
func _ready() -> void:
	data = {
		...
		"perstalt_start_lens": [
			...
			{
				"uid_key": "perstalt_world_daemon",
				"type": "daemon",
				"role": "perstalt_world_daemon",
				"order": 2,
				"wires": [
					{"case": "set", "source": "perstalt_world_daemon", "target": "self", "property": "_daemon"},
					{"case": "signal", "signal": "creation_failed", "target": "self", "method": "_on_creation_failed"},
					{"case": "signal", "signal": "creation_succeeded", "target": "self", "method": "_on_creation_succeeded"},
					{"case": "signal", "signal": "selection_failed", "target": "self", "method": "_on_selection_failed"},
					{"case": "signal", "signal": "selection_succeeded", "target": "self", "method": "_on_selection_succeeded"},
					{"case": "signal", "signal": "deletion_failed", "target": "self", "method": "_on_deletion_failed"},
					{"case": "signal", "signal": "deletion_succeeded", "target": "self", "method": "_on_deletion_succeeded"},
				]
			},
		],
	}
